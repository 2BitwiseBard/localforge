...
MODELS: list[Model] = [
    ...
    {
        "id": "qwen3.5-4b-ud-q4",
        "name": "Qwen3.5-4B · UD-Q4_K_XL (Unsloth dynamic)",
        "family": "qwen3.5",
        "params_b": 4,
        "quant": "UD-Q4_K_XL",
        "size_gb": 2.91,
    ...
    {
        "id": "qwen3.5-9b-ud-q4",
        "name": "Qwen3.5-9B · UD-Q4_K_XL (Unsloth dynamic)",
        "family": "qwen3.5",
        "params_b": 9,
        "quant": "UD-Q4_K_XL",
        "size_gb": 5.97,
    ...
    {
        "id": "qwen3.5-27b-ud-iq4",
        "name": "Qwen3.5-27B · UD-IQ4_XS",
        "family": "qwen3.5",
        "params_b": 27,
        "quant": "UD-IQ4_XS",
        "size_gb": 15.0,
    ...
    # on GPUs that can fit the weights even if dense 35B wouldn't.
    {
        ...
        "name": "Qwen3.5-35B-A3B · UD-Q4_K_XL (MoE)",
        "family": "qwen3.5-moe",
        "params_b": 35,
        "active_b": 3,
        "quant": "UD-Q4_K_XL",
    ...
    {
        "id": "qwen3.5-35b-a3b-ud-q5",
        "name": "Qwen3.5-35B-A3B · UD-Q5_K_XL (MoE)",
        "family": "qwen3.5-moe",
        "params_b": 35,
        "active_b": 3,
        "quant": "UD-Q5_K_XL",
